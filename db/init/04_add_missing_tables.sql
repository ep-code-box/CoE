-- CoE 프로젝트 누락된 테이블 추가 스크립트
-- 버전: 004
-- 설명: 채팅 히스토리 및 문서 생성 작업 추적 테이블 추가
...
-- 4. repository_analyses 테이블에 commit 관련 컬럼 추가
...
('max_chat_history_days', '30', 'INTEGER', '채팅 히스토리 보관 기간 (일)', FALSE),
('auto_summarize_after_turns', '3', 'INTEGER', '자동 요약 실행 턴 수', FALSE),
('max_document_generation_concurrent', '3', 'INTEGER', '동시 문서 생성 작업 수', FALSE),
('default_document_language', 'korean', 'STRING', '기본 문서 생성 언어', TRUE),
('enable_chat_history', 'true', 'BOOLEAN', '채팅 히스토리 저장 활성화', TRUE)
